...
- Alice connects to Pod 1. Her open TCP socket lives in the RAM of Pod 1.
- Bob connects to Pod 4. His open TCP socket lives in the RAM of Pod 4.
- When Alice sends a direct message to Bob, Pod 1 cannot directly write to Bob's socket!
```
