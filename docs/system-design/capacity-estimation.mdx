...
+----------+---------------+----------------+-----------------------+
| 2^10     | 1 KiB (1,024) | 1 KB (1,000)   | Thousand (Kilo)       |
| 2^20     | 1 MiB         | 1 MB (10^6)    | Million (Mega)        |
| 2^30     | 1 GiB         | 1 GB (10^9)    | Billion (Giga)        |
| 2^40     | 1 TiB         | 1 TB (10^12)   | Trillion (Tera)       |
| 2^50     | 1 PiB         | 1 PB (10^15)   | Quadrillion (Peta)    |
+----------+---------------+----------------+-----------------------+
```
...
Daily Active Reads: 100,000,000 requests
Average Object Size: 2 KB
Total Daily Read Data = 100,000,000 * 2 KB = 200 GB

To cache 20% of daily reads:
Working Set = 200 GB * 0.20 = 40 GB RAM

With Redis Object Overhead & Jitter Buffer (1.3x):
Required Redis Cache Size = 40 GB * 1.3 = 52 GB RAM
```
...
```text
Scenario:
Peak Arrival Rate (lambda) = 5,000 requests/sec
Average Service Latency (W) = 40 ms = 0.040 seconds

L = 5,000 * 0.040 = 200 concurrent requests
```
