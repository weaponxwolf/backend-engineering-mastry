...
- Previous Minute (12:00 - 12:01): 80 requests.
- Current Minute (12:01 - 12:02): 30 requests so far.
- Current Time: 12:01:18 (We are 18 seconds into current minute = 30% through window).
- Overlap remaining from previous minute: 100% - 30% = 70% (0.70).

Estimated Rolling Requests = 30 + (80 * 0.70) = 30 + 56 = 86 requests.
